                            ...
                            <table class="table">
                                ...
                                @foreach($book as $item)
                                    <tr>
                                        <td>{{ $item->id }}</td>
                                        <td>{{ $item->title }}</td>
                                        <td class="d-none">{{ $item->content }}</td><td>{{ $item->year }}</td><td>{{ $item->price }}</td><td>{{ $item->isbn }}</td><td>{{ $item->author_id }}</td><td>{{ $item->publisher_id }}</td><td><img src="{{ asset("/storage/{$item->photo}") }}" width="50%"> </td>
                                        <td>
